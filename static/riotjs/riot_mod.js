...
riot.compile = (function () {
  ...
  function GET(url, fn, opts) {
      ...
      /*function xx(txt) {
          alert(txt);
          return fn(txt, opts, url);
      }
      window.ajax_get_response_fun = xx;
      //window.ajax_get_response_opts = opts
      //window.ajax_get_response_url = url
      document.title = ":ajax_get|"+ url;
      
      //cmd_to_python("ajax_get|"+ url);
      */
