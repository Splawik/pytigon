...
var _on_menu_href = function(event) {
  ...
  if ((!(APPLICATION_TEMPLATE instanceof Array ? JSON.stringify(APPLICATION_TEMPLATE)==JSON.stringify("traditional") : APPLICATION_TEMPLATE==="traditional"))) {
    if (__contains__(["standard", "simple", "tablet"], APPLICATION_TEMPLATE)) {
      l = Ladda.create(this);
    }
    title = $(this).text();
            var _on_new_win = function(data) {
      var menu,id;
      if (__contains__(["standard", "tablet"], APPLICATION_TEMPLATE)) {
        menu = get_menu();
    ...
    if ((APPLICATION_TEMPLATE instanceof Array ? JSON.stringify(APPLICATION_TEMPLATE)==JSON.stringify("simple") : APPLICATION_TEMPLATE==="simple")) {
    ...
    if (__contains__(["mobile", "tablet"], APPLICATION_TEMPLATE)) {
