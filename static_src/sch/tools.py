...
def fragment_init(elem=None):
    ...
    elem2.find('.django-select2:not(.select2-full-width)').djangoSelect2({'width': 'calc(100% - 48px)'})
    elem2.find('.django-select2.select2-full-width').djangoSelect2({'width': 'calc(100%)'})
