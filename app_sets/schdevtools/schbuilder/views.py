...
def gen(request, pk):
    ...
    base_path = settings.ROOT_PATH+"/app_sets/"+appset.name
    src_path = settings.ROOT_PATH+"/app_sets/schdevtools/"
    object_list = []
...
def template_edit(request, pk):
    ...
    if len(templates)==0:
        ...
        file_name = settings.ROOT_PATH+("/app_sets/schdevtools/templates_src/schbuilder/wzr/new_generic_%s_template.ihtml" % template_suffix)
...
def template_edit2(request, pk):
    ...
    if len(templates)==0:
        ...
        file_name = settings.ROOT_PATH+"/app_sets/schdevtools/templates_src/schbuilder/wzr/new_generic_form_template.ihtml"
        f = open(file_name, "rt")
        template.template_code = f.read()
        f.close()
        template.save()
...
def installer(request, pk):
    ...
    base_path = settings.ROOT_PATH+"/app_sets/"+appset.name+"/"
    zip_path = settings.ROOT_PATH+"/app_sets/"
