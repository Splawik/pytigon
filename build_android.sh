...
p4a apk --private $HOME/prj/pytigon --dist-name=pytigon  --package=tk.pytigon --arch=armeabi-v7a --name "Pytigon" --version 0.1 --bootstrap=sdl2 \
    --requirements=android,sdl2,kivy,python3crystax,django-bootstrap4,ldap3,django_python3_ldap,django_select2,whitenoise,fpdf,html5lib,markdown2,wsgi_intercept,openpyxl,httpie,PyDispatcher,polib,django-appconf,fs,portend,tempora,cheroot,pillow,lxml,libsass,transcrypt,pyexcel_odsr\
,chardet,django-cors-headers\
