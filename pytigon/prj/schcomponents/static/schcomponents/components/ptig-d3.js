...
var comp = WebComponent ('ptig-d3', false, [BASE_PATH + '/d3/d3.v3.min.js']);
try {
	comp.__enter__ ();
	...
	var connectedCallback = comp.fun ('connectedCallback') (function (component) {
		component.update ();
		var sampleSVG = d3.select (component.getElementsByTagName ('DIV') [0]).append ('svg').attr ('width', 100).attr ('height', 100);
