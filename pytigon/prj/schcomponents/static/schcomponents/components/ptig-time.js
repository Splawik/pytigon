...
try {
	...
	var init = comp.fun ('init') (function (component) {
		var _on_time = function () {
			var d = new Date ();
			var t = d.toISOString ().py_replace ('T', ' ');
			component.set_state (dict ([['time', t.__getslice__ (11, 19, 1)], ['date', t.__getslice__ (0, 10, 1)], ['datetime', t.__getslice__ (0, 19, 1)], ['time_short', t.__getslice__ (11, 16, 1)], ['datetimeshort', t.__getslice__ (0, 16, 1)]]));
		};
