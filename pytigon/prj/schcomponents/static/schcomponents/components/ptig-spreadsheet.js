...
export var TAG = 'ptig-spreadsheet';
export var BASE_PATH = window.BASE_PATH + 'static/vanillajs_plugins';
export var js_libs = [BASE_PATH + '/jexcel/jexcel.js', BASE_PATH + '/jsuites/jsuites.js'];
export var css_libs = [BASE_PATH + '/jsuites/jsuites.css', BASE_PATH + '/jexcel/jexcel.css'];
var comp = DefineWebComponent (TAG, false, js_libs, css_libs);
try {
	comp.__enter__ ();
	...
	var init = comp.fun ('init') (function (component) {
		...
		var data = [['1', '2', '3']];
		component.jtable = jexcel (component, dict ([['data', data], ['columns', columns], ['minDimensions', [10, 10]]]));
	});
	comp.__exit__ ();
}
catch (__except0__) {
