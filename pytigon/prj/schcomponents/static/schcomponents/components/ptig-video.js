// Transcrypt'ed from Python, 2020-10-17 10:52:03
...
export var TAG = 'ptig-video';
export var TEMPLATE = '        <video name=\"videodiv\" class=\"video-js vjs-default-skin\" controls preload=\"auto\" data-bind=\"style-width:width;style-height:height\">\n' +
    ...
    '\n' +
    '';
export var BASE_PATH = window.BASE_PATH + 'static/vanillajs_plugins/video-js';
var comp = DefineWebComponent (TAG, true, [BASE_PATH + '/video.min.js'], [BASE_PATH + '/video-js.min.css']);
try {
	comp.__enter__ ();
	comp.options ['attributes'] = dict ({'width': null, 'height': null, 'src': null, 'type': null});
	comp.options ['template'] = TEMPLATE;
	var init = comp.fun ('init') (function (component) {
		var div = component.root.querySelector ('video');
		videojs.options.flash.swf = 'video-js.swf';
		var _on_video = function () {
			// pass;
		};
		component.player = videojs (div, dict ({}), _on_video);
	});
	comp.__exit__ ();
}
catch (__except0__) {
