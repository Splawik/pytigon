// Transcrypt'ed from Python, 2020-06-07 14:07:54
...
export var ptig_video = function () {
	...
	var mounted = function () {
		...
		this.player = videojs (this.$el, dict ({}), _on_video);
	};
	return dict ({'props': props, 'template': template, 'mounted': mounted});
};
register_vue_component ('ptig-video', ptig_video, [BASE_PATH + '/video.min.js'], [BASE_PATH + '/video-js.min.css']);
