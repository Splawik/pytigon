...
Urls = (
    ...
    (
        "video?schtml=desktop",
        _("Video"),
        None,
        """png://mimetypes/video-x-generic.png""",
    ),
    (
        "wysiwyg?schtml=desktop",
        _("Wysiwyg editor"),
        None,
    ...
    (
        ...
        _("Markdeep"),
        None,
        """png://mimetypes/text-x-generic.png""",
    ),
    (
        "webrtc?schtml=desktop",
        _("WebRTC"),
        None,
