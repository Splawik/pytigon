...
urlpatterns = [
    path("form/", views.form, {}, name="schcomponents_form"),
    path(
        "codeeditor",
        TemplateView.as_view(template_name="schcomponents/code_editor.html"),
        {},
    ),
    path("d3", TemplateView.as_view(template_name="schcomponents/d3.html"), {}),
    path(
        "spreadsheet",
        TemplateView.as_view(template_name="schcomponents/spreadsheet.html"),
        {},
    ),
    path(
        "pivottable",
        TemplateView.as_view(template_name="schcomponents/pivottable.html"),
        {},
    ),
    path("plotly", TemplateView.as_view(template_name="schcomponents/plotly.html"), {}),
    path(
        "leaflet", TemplateView.as_view(template_name="schcomponents/leaflet.html"), {}
    ),
    path("video", TemplateView.as_view(template_name="schcomponents/video.html"), {}),
    path(
        "wysiwyg",
        TemplateView.as_view(template_name="schcomponents/wysiwygeditor.html"),
        {},
    ),
    path("xterm", TemplateView.as_view(template_name="schcomponents/xterm.html"), {}),
    path(
        "calendar",
        TemplateView.as_view(template_name="schcomponents/calendar.html"),
        {},
    ),
    path("mask", TemplateView.as_view(template_name="schcomponents/mask.html"), {}),
    path(
        "markdeep",
        TemplateView.as_view(template_name="schcomponents/markdeep.html"),
        {},
    ),
    ...
    path(
        "scrollaction",
        TemplateView.as_view(template_name="schcomponents/scrollaction.html"),
        {},
    ),
    ...
    path(
        "select2", TemplateView.as_view(template_name="schcomponents/select2.html"), {}
    ),
