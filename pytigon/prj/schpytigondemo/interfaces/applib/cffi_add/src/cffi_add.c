...
static const struct _cffi_global_s _cffi_globals[] = {
  { "add", (void *)_cffi_f_add, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_add },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_cffi_add(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_cffi_add(void) { return NULL; }
#  else
     initcffi_add(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_cffi_add(void)
{
  return _cffi_init("cffi_add", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initcffi_add(void)
{
  _cffi_init("cffi_add", 0x2601, &_cffi_type_context);
}
#endif
