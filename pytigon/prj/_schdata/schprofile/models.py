...
class Profile( models.Model):
    ...
    owner = ext_models.PtigForeignKey(Element, on_delete=models.CASCADE, null=True, blank=True, editable=True, verbose_name='Owner', related_name="profile_owners", limit_choices_to=LIMIT_OWNER)
    config = ext_models.PtigForeignKey(Element, on_delete=models.CASCADE, null=True, blank=True, editable=True, verbose_name='Config', related_name="profile_configs",limit_choices_to=LIMIT_CONFIG)
    user_type = models.CharField('User type', null=True, blank=True, editable=True, max_length=32)
    variant = models.CharField('Profile variant', null=True, blank=True, editable=True, max_length=64)
