// Transcrypt'ed from Python, 2020-10-08 21:30:32
...
export var _on_time = function () {
	var d = new Date ();
	GLOBAL_BUS.emit ('time_str', d.toISOString ().py_replace ('T', ' ').__getslice__ (0, 19, 1));
};
export var GLOBAL_TIMER = setInterval (_on_time, 1000);
