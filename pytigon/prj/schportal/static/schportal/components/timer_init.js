// Transcrypt'ed from Python, 2020-06-12 07:39:00
...
export var _on_time = function () {
	var d = new Date ();
	global_vue_bus.time_str = d.toISOString ().py_replace ('T', ' ').__getslice__ (0, 19, 1);
};
export var VUE_TIMER = setInterval (_on_time, 1000);
