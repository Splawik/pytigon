// Transcrypt'ed from Python, 2020-04-05 11:32:03
...
export var TEMPLATE = '  <div class=\"container\">\n' +
    ...
    '            <div class=\"col-md-12\">\n' +
    '                <div class=\"f\">\n' +
    '                    <ptig-webrtc ref=\"webrtc\" width=\"100%\" :roomId=\"roomId\" :src=\"src\" :host=\"host\" />\n' +
    '                </div>\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </div>\n' +
...
export var _room = function (resolve, reject) {
	var props = ['roomId', 'host'];
	var data = function () {
		var d = dict ({'src': window.BASE_PATH + 'teleconference/teleconference/socket.io/'});
		return d;
	};
	resolve (dict ({'data': data, 'template': TEMPLATE, 'props': props}));
};
