...
class Log( models.Model):
    ...
    date = models.DateTimeField('Date', null=True, blank=True, editable=False, default=datetime.now,)
    ...
    operator_id = models.IntegerField('Operator id', null=True, blank=True, editable=True, )
