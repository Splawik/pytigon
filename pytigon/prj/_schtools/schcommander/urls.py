...
urlpatterns = [
    ...
    re_path("view/(?P<file_name>.*)/$", views.view, {}, name="schcommander_view"),
    re_path(
        "convert_html/(?P<file_name>.*)/$",
        views.convert_html,
        {},
        name="schcommander_convert_html",
    ),
    re_path(
        "convert_pdf/(?P<file_name>.*)/$",
        views.convert_pdf,
        {},
        name="schcommander_convert_pdf",
    ),
    re_path(
        "convert_docx/(?P<file_name>.*)/$",
        views.convert_docx,
        {},
        name="schcommander_convert_docx",
    ),
    re_path(
        "convert_xlsx/(?P<file_name>.*)/$",
        views.convert_xlsx,
        {},
