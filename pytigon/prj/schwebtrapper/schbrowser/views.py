...
class MultiDownload(forms.Form):
    base_address = forms.CharField(label=_('Base address'), required=True, initial='http://learningenglish.voanews.com',max_length=None, min_length=None)
    source_page = forms.CharField(label=_('Source page'), required=False, initial='/archive/learningenglish-programs-radio-in-the-news/latest/1577/1577.html',max_length=None, min_length=None)
    subpage_href = forms.CharField(label=_('Next page mask'), required=False, initial='/archive/learningenglish-programs-radio-in-the-news/.*;@/content/.*',max_length=None, min_length=None)
    download_mask = forms.CharField(label=_('Download href mask'), required=False, initial='.*hq\.mp3.*',max_length=None, min_length=None)
    levels = forms.IntegerField(label=_('Levels'), required=True, initial='10',max_value=None, min_value=None)
