...
class CommandRegistry:
    ...
    def register(self, handler: CommandHandler) -> None:
        ...
        if not isinstance(handler, CommandHandler):
            msg = f"Handler must be an instance of CommandHandler, got {type(handler).__name__}"
            raise TypeError(
                msg,
            )
    ...
    def _get_handler_command_name(self, handler: CommandHandler) -> str | None:
    ...
    def find_handler(self, argv: list[str]) -> CommandHandler | None:
