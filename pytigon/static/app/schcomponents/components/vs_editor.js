// Transcrypt'ed from Python, 2019-12-03 22:25:35
...
export var _vseditor = function (resolve, reject) {
	...
	var imp1 = import (base_path + '/../../system/require.js');
	var imp2 = import (base_path + '/loader.js');
	Promise.all ([imp1, imp2]).then (_on_loadjs0);
};
