...
export var TAG = 'ptig-markdeep';
export var TEMPLATE = '        <div name=\"markdeep style=visibility:hidden\">\n' +
    '                <slot></slot>\n' +
    '        </div>\n' +
    '\n' +
    '';
...
var comp = DefineWebComponent (TAG, true, [BASE_PATH + '/markdeep.min.js'], [BASE_PATH + '/whitepaper.css', BASE_PATH + '/diagram.css']);
try {
	comp.__enter__ ();
	...
	var init = comp.fun ('init') (function (component) {
		...
		var txt = component.childNodes [0].nodeValue;
