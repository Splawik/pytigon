...
import {
  ...
  tuple,
  zip,
} from "../../sch/org.transcrypt.__runtime__.js";
...
export var ptig_xterm = function () {
  ...
  var template =
    "<div class = 'call_on_remove' name='xterm' v-bind:style='{ width: width, height: height}' ></div>";
      ...
      var _on_websocket_open = function () {
        var _fit_to_screen = function () {
          ...
          var s = JSON.stringify(
            dict({ resize: dict({ cols: term.cols, rows: term.rows }) })
          );
          websocket.send(s);
        };
...
register_vue_component(
  "ptig-xterm",
  ptig_xterm,
  [BASE_PATH + "/xterm.js", BASE_PATH + "/fit.js"],
  [BASE_PATH + "/xterm.css"]
);
