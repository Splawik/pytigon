// Transcrypt'ed from Python, 2020-01-01 16:05:38
...
export var _summertextarea = function (resolve, reject) {
	...
	//require ([base_path + '/summernote-bs4.min.js'], _on_loadjs);
	load_js(base_path + '/summernote-bs4.min.js', _on_loadjs);
	load_css (base_path + '/summernote-bs4.css');
	load_css (window.BASE_PATH + 'static/schcomponents/summernote_add.css');
};
Vue.component ('ptig-wysiwygedit', _summertextarea);
