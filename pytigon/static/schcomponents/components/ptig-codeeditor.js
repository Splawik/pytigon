// Transcrypt'ed from Python, 2020-01-01 15:05:01
...
export var _vseditor = function (resolve, reject) {
	...
	require ([window.BASE_PATH + 'static/jquery/jquery-3.2.1.min.js', 'vs/editor/editor.main'], _on_loadjs);
	//import(base_path+'/editor/editor.main.js').then(_on_loadjs);
};
