...
if [ "$(expr substr $(uname -s) 1 5)" == "Linux" ]; then
    ...
    curl -L -o ./ext_prg/tcc-0.9.27.tar.bz2 http://download.savannah.gnu.org/releases/tinycc/tcc-0.9.27.tar.bz2
    tar xjf ./ext_prg/tcc-0.9.27.tar.bz2 -C ./ext_prg/
    rm ./ext_prg/tcc-0.9.27.tar.bz2
    mv ./ext_prg/tcc-0.9.27 ./ext_prg/tcc
    cd ./ext_prg/tcc
...
#    ./python/python -m pip pip install -r requirements.txt
...
#    curl -L -o ./ext_prg/tcc-0.9.27-win32-bin.zip http://download.savannah.gnu.org/releases/tinycc/tcc-0.9.27-win32-bin.zip
#    unzip ./ext_prg/tcc-0.9.27-win32-bin.zip -d ./ext_prg
#    rm ./ext_prg/tcc-0.9.27-win32-bin.zip
    ...
    ./ext_prg/tcc/tcc pytigonw.c -ladvapi32
    ./ext_prg/LinkRes2Exe pytigon.res pytigonw.exe
