...
account_type_choice_2 = (("B", "Balance"), ("O", "Off-balance"), ("N", "Non-financial"))

account_type_choice_1 = (("S", "Synthetic"), ("A", "Analytical"))
...
doctype_status = (("0", "Disabled"), ("1", "Activ"))
...
class DocReg(models.Model):
    ...
    save_head_fun = models.TextField(
        "Save head function", null=True, blank=True, editable=False
    )
    save_item_fun = models.TextField(
        "Save item function", null=True, blank=True, editable=False
    )
...
class DocType(models.Model):
    ...
    correction = ext_models.NullBooleanField(
        "Correction", null=True, blank=True, editable=True
    )
    head_form = models.TextField("Head form", null=True, blank=True, editable=False)
    item_form = models.TextField("Item form", null=True, blank=True, editable=False)
    save_head_fun = models.TextField(
...
class DocHead(JSONModel):
    ...
    parents = models.ManyToManyField(
        "self", null=False, blank=False, editable=False, verbose_name="Parents"
    )
...
class DocItem(JSONModel):
    ...
    order = models.IntegerField(
        "Order", null=False, blank=False, editable=False, default=1
    )
    ...
    level = models.IntegerField(
        "Level", null=False, blank=False, editable=False, default=0
    )
    param1 = models.CharField(
...
class DocRegStatus(models.Model):
    ...
    accept_proc = models.TextField(
        "Accept status procedure", null=True, blank=True, editable=False
    )
    undo_proc = models.TextField(
        "Undo status procedure", null=True, blank=True, editable=False
    )
    can_set_proc = models.TextField(
        "Check if status can be set", null=True, blank=True, editable=False
    )
    can_undo_proc = models.TextField(
        "Check if status can be removed", null=True, blank=True, editable=False
    )
...
class Account(TreeModel):
    ...
    enabled = ext_models.NullBooleanField(
        "Enabled", null=False, blank=False, editable=True, default=True
    )
...
class AccountOperation(models.Model):
    ...
    date = models.DateTimeField(
        "Date", null=False, blank=False, editable=False, default=datetime.datetime.now
    )
    description = models.CharField(
    ...
    account_state = ext_models.ForeignKey(
        AccountState,
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    ...
    sign = models.IntegerField(
        "Sign - debit or credit", null=False, blank=False, editable=True
    )
    amount = models.DecimalField(
        "Amount",
        null=False,
    ...
    enabled = ext_models.NullBooleanField(
        "Enabled", null=True, blank=True, editable=False, default=False
    )
...
class BaseObject(models.Model):
    ...
    template_src = models.TextField(
        "Template source", null=True, blank=True, editable=False
    )
    template = models.TextField("Template", null=True, blank=True, editable=False)
    to_html_rec = models.TextField(
        "Convert fields to html", null=True, blank=True, editable=False
    )
    ...
    to_str_fun = models.TextField(
        "Object to str function", null=True, blank=True, editable=False
    )
    action_template = models.TextField(
        "Action template", null=True, blank=True, editable=False
    )
