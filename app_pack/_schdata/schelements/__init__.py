...
Urls = (
    (
        "table/Element/-/form/list/?schtml=desktop",
        _("Elements"),
        None,
        "client://status/dialog-information.png",
    ),
    (
        "table/Classifier/0/form/tree/?schtml=desktop",
        _("Classifiers"),
        None,
        "client://status/image-missing.png",
    ),
    (
        "table/OrgChartElem/0/form/tree/?schtml=desktop",
        _("Organisation chart"),
        None,
        "client://mimetypes/x-office-drawing.png",
    ),
    (
