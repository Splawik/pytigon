...
def AdditionalUrls():
    ...
    for object in Scripts.objects.all():
        if object.menu:
            ...
            ret.append(("schsimplescripts/run/"+object.name+"/?schtml=1", object.title, object.rights_group, icon, _(module_title) if module_title else "", app_name, _(app_title) if app_title else ""))    
